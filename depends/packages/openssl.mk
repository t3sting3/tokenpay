...
$(package)_config_opts+=no-capieng no-cast no-cms no-dtls1 no-gost no-heartbeats no-idea no-md2
$(package)_config_opts+=no-mdc2 no-rc5 no-rdrand no-rfc3779 no-sctp no-seed no-whirlpool no-rc2 no-rc4 no-ssl2 no-ssl3
